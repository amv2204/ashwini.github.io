...
* Build and maintain a repository of biological samples, clinical data, and epidemiologic data for distribution to investigators by enrolling and obtaining informed consent of patients who are at risk or who have cancer
...
* Clean and analyze data that has been collected from questionnaires and the electronic health record of individuals who have consented to the DBSR protocol
...
* Software skills: Screening Center on Specimen Gate, JerseySurv (VectorSurv), EPIC, Velos, Qualtrics, RMarkdown, GitHub
* Statistical software skills: SAS, R 
